...
public class ArgumentDecimalBetweenGuardTest
{
    ...
    [InlineData(7, 3, 8)]
    public void
        Decimal_ThrowIfIsBetween_Should_Throw_Exception_When_Argument_Is_Between_Start_And_End_Value(decimal argument,
            decimal compareValueStart, decimal compareValueEnd)
    {
    ...
    [InlineData(10, 3, 8)]
    public void
        Decimal_ThrowIfIsBetween_Should_Not_Throw_Exception_When_Argument_Is_Between_Start_And_End_Value(
            decimal argument, decimal compareValueStart, decimal compareValueEnd)
    {
